...
description: "How we helped a sock manufacturer calculate their carbon emissions and pinpoint ways to meet reduction targets"
author: 
...
This project was a unique opportunity to work with a real-world client and apply data science skills to a sustainability challenge. I learned so much about carbon accounting, building interactive dashboards, and the strengths of both Excel and R within a carbon accounting framework. I am grateful for the opportunity to contribute to Darn Tough's sustainability efforts and I look forward to seeing how Darn Tough uses these tools to reduce their emissions and continue their commitment to sustainability. From co writing the proposal for this project to seeing it through to the finished project, I am so proud of the outcome that our team achieved.
